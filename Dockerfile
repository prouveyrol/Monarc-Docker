...
RUN apt-get update && apt-get install -y zip unzip git gettext curl gsfonts && rm -rf /var/lib/apt/lists/*
RUN curl -sL https://deb.nodesource.com/setup_14.x | bash -
RUN apt-get update && apt-get install -y nodejs libmagickwand-dev --no-install-recommends && rm -rf /var/lib/apt/lists/*
